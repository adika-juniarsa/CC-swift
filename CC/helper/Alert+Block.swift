...
// https://github.com/smindia1988/EasyAlertInSwift4
...
class Alert:UIViewController{
    ...
    static let topVC = (UIApplication.shared.delegate as! AppDelegate).window?.rootViewController as! LGSideMenuController
    ...
    class func showAlert(title:String?, message:String?,handler:AlertCompletionHandler){
        let alert = UIAlertController(title:title, message: message, preferredStyle:.alert)
